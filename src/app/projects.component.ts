  ...
  projects: Project[] = [
    {
      ...
      githubUrl: 'https://github.com/Samtaupe/portfolio-oppe',
      emoji: '🌐',
      featured: true,
    },
    {
      title: 'Id-eFix',
      description: 'Ce projet scolaire permet par l\'utilisation d\'un modèle de classification de détecter sur une image la présence d\'Astérix ou d\'Obélix.',
      tags: ['HTML', 'CSS'],
      githubUrl: 'https://github.com/Samtaupe/Id-eFixe',
      emoji: '🚀',
    },
    {
      title: 'Migration technique',
      description: 'Ce projet scolaire consiste à repprendre un site web statique et à le migrer vers une architecture plus moderne, avec un design responsive et une meilleure expérience utilisateur.',
      tags: ['Angular', 'TypeScript'],
      githubUrl: 'https://github.com/Samtaupe/ParcAttraction-OPPE-Thomas',
      emoji: '➕',
      featured: false,
    },
    {
      title: 'WebGL-Magritte',
      description: 'Ce projet scolaire représente une scène 3D de la peinture le fils de l\'homme de Magritte, avec un rendu en temps réel grâce à WebGL.',
      tags: ['WebGL'],
      githubUrl: 'https://homepages.loria.fr/PFVillard/projetsWebGL/projet2024/oppe/',
      emoji: '⚡',
      featured: true,
    }
  ];
